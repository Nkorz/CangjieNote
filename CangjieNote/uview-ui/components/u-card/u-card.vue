    ...
    <view v-if="showHead" class="u-card__head" :style="[{padding: padding + 'rpx'}, headStyle]" :class="{
      ...
      <view v-if="!$slots.head" class="u-flex u-row-between">
        <view class="u-card__head--left u-flex u-line-1" v-if="title">
          ...
          <text class="u-card__head--left__title u-line-1 title">
            {{ title }}
          </text>
        </view>
        <view class="subtitle u-card__head--right u-line-1" v-if="subTitle">
          <text class="u-card__head__title__text" >
            {{ subTitle }}
          </text>
        </view>
      </view>
